...
import static com.pawel.kantor.praca.inzynierska.R.layout.activity_game;

/**
 * Created by Pawel on 6.11.2017.
 */
...
public class Game extends AppCompatActivity {
        ...
        else
        {
            ...
            bYes.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    finish();
                    Intent intent = new Intent(getApplicationContext(), com.pawel.kantor.praca.inzynierska.Menu.class);
    ...
    private void prepareDrawer()
    {
        ...
        cbAcceptMove.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                {
                    deleteLastLine();
                    ivBall.setX(_source.getLeft() + _source.getWidth() / 4);
                    ivBall.setY(_source.getTop() + _source.getHeight() / 4);
                }
    ...
    private void setVisibilityAcceptMove(boolean visible)
    {
        doShowAcceptButton = visible;
        if (!visible)
            bAcceptMove.setVisibility(View.INVISIBLE);
        else
            bAcceptMove.setVisibility(View.VISIBLE);
    }

    private void setVisibilityPlayerNames(boolean visible)
    {
    ...
    private void setEnabledVibrations(boolean enable)
    {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bAcceptMove = (Button) findViewById(R.id.acceptMove);
        player1 = new Player();
        player2 = new Player();
        ...
        countY = sharedPreferences.getInt(getString(R.string.SP_count_y), 50);
        countX = sharedPreferences.getInt(getString(R.string.SP_count_x), 50);
                    ...
                    switch (motionEvent.getAction()) {
                        case MotionEvent.ACTION_DOWN:
                            if ((isMyTurn() || gameMode == LOCAL)) {
                                _lastDestination = (ImageView) findViewById(field.getId());
                            if (makeMove())
                                if (!doShowAcceptButton)
                                    bAcceptMove.performClick();
                            ...
                            case 5:
                                if (gameMode == BLUETOOTH)
                                    if (!gSocket.getAmIConnected())
                                    {
                                        ...
                                        Intent intent = new Intent(Game.this, com.pawel.kantor.praca.inzynierska.Menu.class);
                                        intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                                        startActivity(intent);
                                    }
        ...
        if (!tryToCreateLine(_source, _lastDestination)) {
            ...
            if (checkIfShotPossible(_source, _lastDestination)) {
                ...
                if (drawLine(_source, _destination)) {
                    ...
                    ivBall.setX(_destination.getLeft() + _destination.getWidth() / 4);
                    ivBall.setY(_destination.getTop() + _destination.getHeight() / 4);
                    ivBall.bringToFront();
                    ivBall.invalidate();
                    return true;
                }
    ...
    private void startNewGame(Player winner, Player loser)
    {
    ...
    private boolean tryToCreateLine(ImageView src, ImageView dst)
    {
    ...
    private boolean checkIfShotPossible(ImageView source, ImageView destination)
    {
    ...
    private boolean checkIfGameOver(int possibleMoves, int fieldId)
    {
        int[] p2Goal  = {4, 5, 6};
    ...
    private boolean checkIfPointsGained()
    {
    ...
    private boolean drawLine(ImageView source, ImageView destination)
    {
        Line line = new Line(this);
    ...
    {
        int MIDDLE = 71;
        Ball ball = new Ball(this, listViews.get(MIDDLE));
        ...
        ivBall = ball;
        frameLayout.addView(ivBall, params);
    }

    private void blockMoveOutsideField()
    {
